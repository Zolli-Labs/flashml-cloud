    ...
    >
      <div className="mx-auto max-w-[1240px] px-5 sm:px-6">
        <SectionReveal className="pb-10 md:pb-14">
          <div data-reveal-content className="grid gap-8 md:grid-cols-[.72fr_1.28fr] md:gap-12">
        ...
        <SectionReveal>
          <ol data-reveal-content className="grid border-t border-white/18 pt-10 md:grid-cols-3 md:pt-14">
          ...
          <div data-reveal-content className="mt-10 grid gap-8 border-t border-white/12 pt-8 sm:grid-cols-2 md:mt-14 md:pt-10">
