  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1240px] px-5 sm:px-6">
        <SectionReveal>
          <div data-reveal-content className="grid gap-10 lg:grid-cols-[.95fr_1.05fr] lg:gap-16">
            <div>
          ...
          <div data-reveal-content className="mt-14 border-t border-[var(--z-border-strong)] md:mt-20">
