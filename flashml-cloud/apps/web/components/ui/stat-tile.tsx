 ...
 *
 * NOT the register for a page-leading strip of counts: that is
 * `components/shared/StatStrip`, the instrument-panel hairline row, which is
 * where `w/[poolId]/overview` and `account/machines` lead. `StatTile` is for
 * a tile inside a card, a cell in a caller-owned `<dl>`, or a header figure.
 *
