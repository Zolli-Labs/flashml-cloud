  ...
  return (
    ...
    >
      ...
      <Section
        ...
        note="components/ui/stat-tile.tsx. Was seven separate hand-written Stat()/CountTile()/HeaderStat() functions across metrics, market/listings, w/[poolId]/overview, RoundProgress, TradeoffCard, RoutingCard and JobRecovery — see docs/superpowers/specs/2026-08-13-console-density-audit.md §4. All seven now render through this one component."
      >
